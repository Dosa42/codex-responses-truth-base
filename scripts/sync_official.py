...
SOURCES = {
    ...
    "upstream/docs/websocket-mode.md": "https://developers.openai.com/api/docs/guides/websocket-mode.md",
    ...
    "upstream/docs/web-search.md": "https://developers.openai.com/api/docs/guides/tools-web-search.md",
    "upstream/docs/file-search.md": "https://developers.openai.com/api/docs/guides/tools-file-search.md",
    ...
    "upstream/docs/image-generation.md": "https://developers.openai.com/api/docs/guides/tools-image-generation.md",
    "upstream/docs/mcp-connectors.md": "https://developers.openai.com/api/docs/guides/tools-connectors-mcp.md",
    "upstream/docs/secure-mcp-tunnels.md": "https://developers.openai.com/api/docs/guides/secure-mcp-tunnels.md",
